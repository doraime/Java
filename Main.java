...
class Lab2 {
  ...
  public void stack() {
    ...
    System.out.println("Peeked book: "+bookStack.peek());
    ...
    System.out.println("Design Patterns search: "+bookStack.search("Design Patterns"));
    // 19. Call empty(). Output the results
    bookStack.empty();
    System.out.println("bookStack results: "+bookStack);
